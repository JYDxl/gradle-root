 ...
 * @author JYD_XL
 */
@TableName("quartz_qrtz_blob_triggers")
@ApiModel(value = "QuartzQrtzBlobTriggersEntity对象", description = "")
open class QuartzQrtzBlobTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "QuartzQrtzBlobTriggersEntity{" +
        "schedName=" + schedName +
