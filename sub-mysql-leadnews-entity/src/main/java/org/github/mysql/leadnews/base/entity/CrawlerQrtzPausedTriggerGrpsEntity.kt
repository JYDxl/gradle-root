 ...
 * @author JYD_XL
 */
@TableName("crawler_qrtz_paused_trigger_grps")
@ApiModel(value = "CrawlerQrtzPausedTriggerGrpsEntity对象", description = "")
open class CrawlerQrtzPausedTriggerGrpsEntity : Entity() {
    ...
    override fun toString(): String {
        return "CrawlerQrtzPausedTriggerGrpsEntity{" +
        "schedName=" + schedName +
