 ...
 * @author JYD_XL
 */
@TableName("migration_qrtz_locks")
@ApiModel(value = "MigrationQrtzLocksEntity对象", description = "")
open class MigrationQrtzLocksEntity : Entity() {
    ...
    override fun toString(): String {
        return "MigrationQrtzLocksEntity{" +
        "schedName=" + schedName +
        ", lockName=" + lockName +
        "}"
    }
