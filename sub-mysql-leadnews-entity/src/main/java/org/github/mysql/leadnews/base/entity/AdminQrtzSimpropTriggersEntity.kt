 ...
 * @author JYD_XL
 */
@TableName("admin_qrtz_simprop_triggers")
@ApiModel(value = "AdminQrtzSimpropTriggersEntity对象", description = "")
open class AdminQrtzSimpropTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "AdminQrtzSimpropTriggersEntity{" +
        "schedName=" + schedName +
