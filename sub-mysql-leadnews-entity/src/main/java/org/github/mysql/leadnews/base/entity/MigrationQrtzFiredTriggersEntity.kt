 ...
 * @author JYD_XL
 */
@TableName("migration_qrtz_fired_triggers")
@ApiModel(value = "MigrationQrtzFiredTriggersEntity对象", description = "")
open class MigrationQrtzFiredTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "MigrationQrtzFiredTriggersEntity{" +
        "schedName=" + schedName +
        ", entryId=" + entryId +
