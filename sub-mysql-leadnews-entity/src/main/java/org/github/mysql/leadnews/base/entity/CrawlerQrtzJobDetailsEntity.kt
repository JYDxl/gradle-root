 ...
 * @author JYD_XL
 */
@TableName("crawler_qrtz_job_details")
@ApiModel(value = "CrawlerQrtzJobDetailsEntity对象", description = "")
open class CrawlerQrtzJobDetailsEntity : Entity() {
    ...
    override fun toString(): String {
        return "CrawlerQrtzJobDetailsEntity{" +
        "schedName=" + schedName +
        ", jobName=" + jobName +
        ", jobGroup=" + jobGroup +
