 ...
 * @author JYD_XL
 */
@TableName("crawler_qrtz_cron_triggers")
@ApiModel(value = "CrawlerQrtzCronTriggersEntity对象", description = "")
open class CrawlerQrtzCronTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "CrawlerQrtzCronTriggersEntity{" +
        "schedName=" + schedName +
