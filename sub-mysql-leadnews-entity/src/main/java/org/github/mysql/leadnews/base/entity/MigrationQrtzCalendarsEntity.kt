 ...
 * @author JYD_XL
 */
@TableName("migration_qrtz_calendars")
@ApiModel(value = "MigrationQrtzCalendarsEntity对象", description = "")
open class MigrationQrtzCalendarsEntity : Entity() {
    ...
    override fun toString(): String {
        return "MigrationQrtzCalendarsEntity{" +
        "schedName=" + schedName +
