 ...
 * @author JYD_XL
 */
@TableName("admin_qrtz_triggers")
@ApiModel(value = "AdminQrtzTriggersEntity对象", description = "")
open class AdminQrtzTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "AdminQrtzTriggersEntity{" +
        "schedName=" + schedName +
