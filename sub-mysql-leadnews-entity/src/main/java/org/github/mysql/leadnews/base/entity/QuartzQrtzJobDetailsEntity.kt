 ...
 * @author JYD_XL
 */
@TableName("quartz_qrtz_job_details")
@ApiModel(value = "QuartzQrtzJobDetailsEntity对象", description = "")
open class QuartzQrtzJobDetailsEntity : Entity() {
    ...
    override fun toString(): String {
        return "QuartzQrtzJobDetailsEntity{" +
        "schedName=" + schedName +
        ", jobName=" + jobName +
        ", jobGroup=" + jobGroup +
