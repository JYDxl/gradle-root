 ...
 * @author JYD_XL
 */
@TableName("migration_qrtz_simple_triggers")
@ApiModel(value = "MigrationQrtzSimpleTriggersEntity对象", description = "")
open class MigrationQrtzSimpleTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "MigrationQrtzSimpleTriggersEntity{" +
        "schedName=" + schedName +
