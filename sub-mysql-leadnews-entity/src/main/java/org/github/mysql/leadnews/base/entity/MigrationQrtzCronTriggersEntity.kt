 ...
 * @author JYD_XL
 */
@TableName("migration_qrtz_cron_triggers")
@ApiModel(value = "MigrationQrtzCronTriggersEntity对象", description = "")
open class MigrationQrtzCronTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "MigrationQrtzCronTriggersEntity{" +
        "schedName=" + schedName +
