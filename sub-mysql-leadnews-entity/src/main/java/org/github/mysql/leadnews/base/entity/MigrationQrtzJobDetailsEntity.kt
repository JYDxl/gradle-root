 ...
 * @author JYD_XL
 */
@TableName("migration_qrtz_job_details")
@ApiModel(value = "MigrationQrtzJobDetailsEntity对象", description = "")
open class MigrationQrtzJobDetailsEntity : Entity() {
    ...
    override fun toString(): String {
        return "MigrationQrtzJobDetailsEntity{" +
        "schedName=" + schedName +
        ", jobName=" + jobName +
        ", jobGroup=" + jobGroup +
