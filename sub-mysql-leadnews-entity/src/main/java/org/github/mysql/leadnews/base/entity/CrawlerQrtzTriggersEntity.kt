 ...
 * @author JYD_XL
 */
@TableName("crawler_qrtz_triggers")
@ApiModel(value = "CrawlerQrtzTriggersEntity对象", description = "")
open class CrawlerQrtzTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "CrawlerQrtzTriggersEntity{" +
        "schedName=" + schedName +
