 ...
 * @author JYD_XL
 */
@TableName("migration_qrtz_simprop_triggers")
@ApiModel(value = "MigrationQrtzSimpropTriggersEntity对象", description = "")
open class MigrationQrtzSimpropTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "MigrationQrtzSimpropTriggersEntity{" +
        "schedName=" + schedName +
