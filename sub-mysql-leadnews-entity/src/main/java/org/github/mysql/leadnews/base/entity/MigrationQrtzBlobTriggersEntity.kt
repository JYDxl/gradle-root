 ...
 * @author JYD_XL
 */
@TableName("migration_qrtz_blob_triggers")
@ApiModel(value = "MigrationQrtzBlobTriggersEntity对象", description = "")
open class MigrationQrtzBlobTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "MigrationQrtzBlobTriggersEntity{" +
        "schedName=" + schedName +
