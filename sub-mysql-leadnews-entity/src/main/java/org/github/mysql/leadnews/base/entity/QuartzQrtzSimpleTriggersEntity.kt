 ...
 * @author JYD_XL
 */
@TableName("quartz_qrtz_simple_triggers")
@ApiModel(value = "QuartzQrtzSimpleTriggersEntity对象", description = "")
open class QuartzQrtzSimpleTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "QuartzQrtzSimpleTriggersEntity{" +
        "schedName=" + schedName +
