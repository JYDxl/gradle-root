 ...
 * @author JYD_XL
 */
@TableName("migration_qrtz_paused_trigger_grps")
@ApiModel(value = "MigrationQrtzPausedTriggerGrpsEntity对象", description = "")
open class MigrationQrtzPausedTriggerGrpsEntity : Entity() {
    ...
    override fun toString(): String {
        return "MigrationQrtzPausedTriggerGrpsEntity{" +
        "schedName=" + schedName +
