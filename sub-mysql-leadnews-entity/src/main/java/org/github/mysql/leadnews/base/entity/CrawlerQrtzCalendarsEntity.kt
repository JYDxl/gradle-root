 ...
 * @author JYD_XL
 */
@TableName("crawler_qrtz_calendars")
@ApiModel(value = "CrawlerQrtzCalendarsEntity对象", description = "")
open class CrawlerQrtzCalendarsEntity : Entity() {
    ...
    override fun toString(): String {
        return "CrawlerQrtzCalendarsEntity{" +
        "schedName=" + schedName +
