 ...
 * @author JYD_XL
 */
@TableName("migration_qrtz_scheduler_state")
@ApiModel(value = "MigrationQrtzSchedulerStateEntity对象", description = "")
open class MigrationQrtzSchedulerStateEntity : Entity() {
    ...
    override fun toString(): String {
        return "MigrationQrtzSchedulerStateEntity{" +
        "schedName=" + schedName +
