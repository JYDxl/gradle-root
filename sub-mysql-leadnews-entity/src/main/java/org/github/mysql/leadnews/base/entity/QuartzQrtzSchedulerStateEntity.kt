 ...
 * @author JYD_XL
 */
@TableName("quartz_qrtz_scheduler_state")
@ApiModel(value = "QuartzQrtzSchedulerStateEntity对象", description = "")
open class QuartzQrtzSchedulerStateEntity : Entity() {
    ...
    override fun toString(): String {
        return "QuartzQrtzSchedulerStateEntity{" +
        "schedName=" + schedName +
