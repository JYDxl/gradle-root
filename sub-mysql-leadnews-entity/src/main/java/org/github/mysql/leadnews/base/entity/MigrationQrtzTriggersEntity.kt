 ...
 * @author JYD_XL
 */
@TableName("migration_qrtz_triggers")
@ApiModel(value = "MigrationQrtzTriggersEntity对象", description = "")
open class MigrationQrtzTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "MigrationQrtzTriggersEntity{" +
        "schedName=" + schedName +
