 ...
 * @author JYD_XL
 */
@TableName("quartz_qrtz_fired_triggers")
@ApiModel(value = "QuartzQrtzFiredTriggersEntity对象", description = "")
open class QuartzQrtzFiredTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "QuartzQrtzFiredTriggersEntity{" +
        "schedName=" + schedName +
        ", entryId=" + entryId +
