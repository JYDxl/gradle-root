 ...
 * @author JYD_XL
 */
@TableName("admin_qrtz_scheduler_state")
@ApiModel(value = "AdminQrtzSchedulerStateEntity对象", description = "")
open class AdminQrtzSchedulerStateEntity : Entity() {
    ...
    override fun toString(): String {
        return "AdminQrtzSchedulerStateEntity{" +
        "schedName=" + schedName +
