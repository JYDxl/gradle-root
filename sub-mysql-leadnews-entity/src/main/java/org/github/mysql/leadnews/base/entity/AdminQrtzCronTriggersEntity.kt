 ...
 * @author JYD_XL
 */
@TableName("admin_qrtz_cron_triggers")
@ApiModel(value = "AdminQrtzCronTriggersEntity对象", description = "")
open class AdminQrtzCronTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "AdminQrtzCronTriggersEntity{" +
        "schedName=" + schedName +
