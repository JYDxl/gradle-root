 ...
 * @author JYD_XL
 */
@TableName("cl_news_material")
@ApiModel(value = "ClNewsMaterialEntity对象", description = "爬得图文引用素材信息表")
open class ClNewsMaterialEntity : Entity() {
