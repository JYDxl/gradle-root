 ...
 * @author JYD_XL
 */
@TableName("quartz_qrtz_paused_trigger_grps")
@ApiModel(value = "QuartzQrtzPausedTriggerGrpsEntity对象", description = "")
open class QuartzQrtzPausedTriggerGrpsEntity : Entity() {
    ...
    override fun toString(): String {
        return "QuartzQrtzPausedTriggerGrpsEntity{" +
        "schedName=" + schedName +
