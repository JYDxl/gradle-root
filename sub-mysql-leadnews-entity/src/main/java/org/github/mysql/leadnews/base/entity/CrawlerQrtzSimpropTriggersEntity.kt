 ...
 * @author JYD_XL
 */
@TableName("crawler_qrtz_simprop_triggers")
@ApiModel(value = "CrawlerQrtzSimpropTriggersEntity对象", description = "")
open class CrawlerQrtzSimpropTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "CrawlerQrtzSimpropTriggersEntity{" +
        "schedName=" + schedName +
