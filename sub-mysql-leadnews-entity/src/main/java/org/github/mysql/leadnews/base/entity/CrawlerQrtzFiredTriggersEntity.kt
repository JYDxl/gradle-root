 ...
 * @author JYD_XL
 */
@TableName("crawler_qrtz_fired_triggers")
@ApiModel(value = "CrawlerQrtzFiredTriggersEntity对象", description = "")
open class CrawlerQrtzFiredTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "CrawlerQrtzFiredTriggersEntity{" +
        "schedName=" + schedName +
        ", entryId=" + entryId +
