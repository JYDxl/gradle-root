 ...
 * @author JYD_XL
 */
@TableName("admin_qrtz_simple_triggers")
@ApiModel(value = "AdminQrtzSimpleTriggersEntity对象", description = "")
open class AdminQrtzSimpleTriggersEntity : Entity() {
    ...
    override fun toString(): String {
        return "AdminQrtzSimpleTriggersEntity{" +
        "schedName=" + schedName +
