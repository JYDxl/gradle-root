 ...
 * @author JYD_XL
 */
@TableName("t_sys_role_resource_rela")
@ApiModel(value = "SysRoleResourceRelaEntity对象", description = "角色资源管理")
open class SysRoleResourceRelaEntity : Entity() {
    ...
    override fun toString(): String {
        return "SysRoleResourceRelaEntity{" +
        "id=" + id +
