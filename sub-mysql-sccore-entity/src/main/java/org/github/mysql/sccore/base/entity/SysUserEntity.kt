...
@ApiModel(value = "SysUserEntity对象", description = "用户管理")
open class SysUserEntity : Entity() {
    ...
    /** 用户锁定状态，1：是，2：否 */
    @ApiModelProperty(value = "用户锁定状态，1：是，2：否")
    @TableField("user_lock_flag")
    open var userLockFlag: String? = null

    /** 用户启用标志，1：可用，2：不可用 */
    @ApiModelProperty(value = "用户启用标志，1：可用，2：不可用")
    @TableField("use_flag")
