...
class ErrorController @Autowired constructor(errorAttributes: ErrorAttributes, serverProperties: ServerProperties): AbstractErrorController(errorAttributes) {
  ...
  @RequestMapping
  fun error(request: HttpServletRequest): JSONBase {
    ...
    //   return JSONBase.of(status, null);
    // }
  ...
  // @NotNull
  // private JSONBase ex(Object trace) {
  ...
  //       return JSONBase.of(UNAUTHORIZED, msg);
  //     }
  //   }
  //   return JSONBase.of(INTERNAL_SERVER_ERROR, null);
  // }
