...
class AuthController {
  ...
  fun permissionList(): JSONArray<String> = JSONArray.of(getPermissionList())

  @ApiOperation("授权功能-角色列表")
  @PostMapping("roleList")
  fun roleList(): JSONArray<String> = JSONArray.of(getRoleList())

  @ApiOperation("授权功能-菜单列表")
  @PostMapping("menuList")
  fun menuList(): JSONArray<String> = centerService.menuList()
}
