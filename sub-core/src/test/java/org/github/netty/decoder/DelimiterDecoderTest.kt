...
internal class DelimiterDecoderTest {
  ...
  fun decode() {
    ...
    val msg1 = requireNotNull(channel.readInbound<String>())
    assertEquals(msg1, "2333")
    val msg2 = requireNotNull(channel.readInbound<String>())
    assertEquals(msg2, "1234")
    val msg3 = requireNotNull(channel.readInbound<String>())
    assertEquals(msg3, "awsl")
    val msg4 = requireNotNull(channel.readInbound<String>())
